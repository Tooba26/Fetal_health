...
with st.container():
    ...
    fetal_movement = st.number_input("Fetal Movement", min_value=0.0, max_value=0.481, format="%.3f")
    uterine_contractions = st.number_input("Uterine Contractions", min_value=0.0, max_value=0.015, format="%.3f")
    light_decelerations = st.number_input("Light Decelerations", min_value=0.0, max_value=0.015, format="%.3f")
    severe_decelerations = st.number_input("Severe Decelerations", min_value=0.0, max_value=0.001, format="%.3f")
    prolonged_decelerations = st.number_input("Prolonged Decelerations", min_value=0.0, max_value=0.005, format="%.3f")
    ...
    mean_value_of_long_term_variability = st.number_input("Mean vlaue of long term variability", min_value=-1.0, max_value=1.0)
